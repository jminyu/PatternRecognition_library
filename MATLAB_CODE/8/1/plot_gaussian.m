...
% EPS Çü½ÄÀ¸·Î ÁöÁ¤µÈ ÆÄÀÏ¿¡ ÀúÀåÇÒ ¼ö ÀÖ°Ô ¹Ù²Ù±âÀ§ÇØ¼­´Â
% 'mesh' ¸í·ÉÀº ÇØ»óµµ¸¦ ¿Ã·Á ±×·ÁÁÖ¾î¾ß ÇÑ´Ù. ÀÌ °æ¿ì¿¡´Â À§ÀÇ 5ÁÙ ´ë½Å ´ÙÀÀÇ 4ÁÙÀ» »ç¿ëÇÒ °Í
...
%    plot3(reshape(ex',1,n*n),reshape(ey',1,n*n),reshape(ez',1,n*n),colour)
  ...
  fprintf('\n°øºÐ»ê Çà·ÄÀÌ ÁÁÁö ¾Ê¾Æ ±×·ÁÁÙ¼ö°¡ ¾ø³×¿ä\n')
end
